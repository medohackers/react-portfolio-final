...
export const Blogs = [
    {
        id:1,
        name:"قبل عمليه تحليل الذهب في السوق العالمي",
        tags:["XAUUSD","GOLD","Trading"],
        date:"14 Oct, 2025",
        imgSrc:"https://files.catbox.moe/djzwzg.jpg",
        link:""
    },
    {
        id:2,
        name:"•السعر عمل تصحيح (ABC) ونزل لمنطقة طلب قوية (OB + FVG).•	حصل تجميع بعدها وانطلاق قوي لفوق (اتجاه صاعد).•اي رجوع للدعم ممكن يكون فرصة شراء طالما مفيش كسر.",
        tags:["XAUUSD","GOLD","Trading"],
        date:"14 Oct, 2025",
    ...
    {
        id:3,
        name:"مراقبه السهم وتوقع رفع لسهم مره اخري",
        tags:["XAUUSD","GOLD","Trading"],
        date:"7 Dec, 2025",
        imgSrc:"https://files.catbox.moe/skic2d.jpg",
        link:""
    },
    {
        id:4,
